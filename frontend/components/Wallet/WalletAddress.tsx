...
import { getStarknetAccount } from "@/lib/wallet"; // Import your deterministic logic
...
export default function WalletAddress() {
  ...
  useEffect(() => {
    if (ready && user) {
      // Generate the same address used in your Dashboard
...
//   const displayAddr = typeof starknetAddress === 'string' && starknetAddress.length > 10
