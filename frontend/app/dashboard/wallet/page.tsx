      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-8 rounded-3xl bg-red-500/5 border border-red-500/10 backdrop-blur-xl">
            ...
            <p
              className={`text-xs font-mono break-all p-4 bg-black/40 rounded-xl border border-red-900/20 text-red-200 transition-all duration-300 ${showKey ? "blur-0" : "blur-md select-none"}`}>
              {privateKey}
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          {MOCK_ASSETS.map((asset) => (
            <div
              key={asset.symbol}
              className="p-6 rounded-2xl bg-linear-to-br from-slate-900/60 to-slate-950 border border-slate-800 hover:border-indigo-500/30 transition-all group">
