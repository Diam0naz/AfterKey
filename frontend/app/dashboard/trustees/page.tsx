      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
        ...
        <div className="lg:col-span-2 p-8 rounded-3xl bg-slate-900/40 border border-slate-800 backdrop-blur-xl shadow-2xl sticky top-24">
          ...
          <div className="space-y-6">
            ...
            >
              {loading ? <div className="animate-spin rounded-full h-5 w-5 border-2 border-white/30 border-t-white" /> : <><Plus size={18}/> Assign Trustee</>}
            </button>
          </div>
        </div>
        {}
              ...
              {trustees.length === 0 ? (
                ...
                trustees.map((t, index) => (
                  ...
                  >
                    ...
                    <button className="p-3 text-slate-600 hover:text-red-400 hover:bg-red-400/5 rounded-xl transition-all">
                      <Trash2 size={20} />
                    </button>
                  </motion.div>
                ))
